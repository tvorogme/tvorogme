...
const siteCopies = {
  ...
  ru: {
    ...
    loreEntries: [
      ...
      },
      {
        ...
        text: "Доточил ценностное предложение OpenGuild.",
      },
      {
    ...
    questCopies: {
      ...
      openguild: {
        description:
          "Красивый способ говорить о проектах, навыках и прогрессе через интерфейс приключенческой гильдии.",
        displayStatus: "Полусобран",
        goal: "Сделать прогресс проектов, навыки и лор читаемыми как гильдию публичного создателя.",
        outcome:
          "Этот сайт использует визуальный язык OpenGuild как интерфейсный слой.",
        summary: "Приключенческая гильдия для публичных создателей и прогресс-лора.",
        tagline: "Приключенческая гильдия для публичных создателей",
        topThings: [
          "Доска квестов публичного создателя",
          "Прогресс, навыки и лор в одном стиле",
          "Визуальный язык этого сайта",
        ],
        whyStarted:
          "Более интересный способ показать работу, чем статичное портфолио или журнал изменений.",
      },
      sanges: {
        description:
  ...
  zh: {
    ...
    questCopies: {
      ...
      openguild: {
        description:
          "一种通过冒险公会界面讲述项目、技能和进度的漂亮方式。",
        displayStatus: "半完成",
        goal: "让项目进度、技能和故事线像 public-builder 公会一样可读。",
        outcome: "这个网站把 OpenGuild 的视觉语言用作界面层。",
        summary: "面向 public builders 和进度故事的冒险公会。",
        tagline: "面向 public builders 的冒险公会",
        topThings: [
          "Public-builder 任务板",
          "进度、技能和故事线统一成一种风格",
          "这个网站的视觉语言",
        ],
        whyStarted: "比静态作品集或 changelog 更有趣的展示工作方式。",
      },
      sanges: {
        description:
